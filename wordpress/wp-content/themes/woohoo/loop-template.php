...
else
{
	...
	if ( $GLOBALS['template_layout'] == 'blockStyle2' ) {
		?>
        <div class="bdaia-blocks bdaia-block2">
            <div class="bdaia-blocks-container">
				<?php
	...
	elseif ( $GLOBALS['template_layout'] == 'blockStyle6' ) {
		?>
    ...
    elseif ( $GLOBALS['template_layout'] == 'blockStyle4' ) {
	    ?>
        <div class="bdaia-row">
    ...
    elseif ( $GLOBALS['template_layout'] == 'blockStyle7' ) {
	    ?>
        <div class="bdaia-row">
    ...
    elseif ( $GLOBALS['template_layout'] == 'blockStyle5' ) {
	    ?>
        <div class="bdaia-row">
    ...
    elseif ( $GLOBALS['template_layout'] == 'blockStyle3' ) {
	    ?>
        <div class="bdaia-row">
    ...
    elseif ( $GLOBALS['template_layout'] == 'blockStyle9' ) {
	    ?>
        <div class="bdaia-row">
    ...
    elseif ( $GLOBALS['template_layout'] == 'blockStyle10' ) {
	    ?>
        <div class="bdaia-row">
    ...
    elseif ( $GLOBALS['template_layout'] == 'blockStyle11' ) {
	    ?>
        <div class="bdaia-row">
    ...
    elseif ( $GLOBALS['template_layout'] == 'blockStyle12' ) {
	    ?>
    ...
    elseif ( $GLOBALS['template_layout'] == 'blockStyle13' ) {
	    ?>
