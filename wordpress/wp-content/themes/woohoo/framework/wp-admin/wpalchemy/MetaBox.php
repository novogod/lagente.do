...
class WPAlchemy_MetaBox
{
	 ...
	 *
	 * @since   1.3
	 * @see     _enqueue_scripts()
	 */
	static public function _enqueue_scripts()
	{
		wp_enqueue_script("global_head_js",get_template_directory_uri().'/framework/admin/js/global_head.js',array( 'jquery', 'jquery-ui-core', 'jquery-ui-widget', 'jquery-ui-mouse', 'jquery-ui-sortable', 'jquery-ui-slider' ),'1.0');
		wp_enqueue_style("global_head_css",get_template_directory_uri().'/framework/admin/css/global_head.css',array());
	}
