jQuery(function($)
    {
        ...
        $('[class*=docopy-]').on("click",function(e)
        {
            ...
            var cscore = 0;
            var id = $('.last.tocopy.wpa_group-'+ the_name).prev();

            id.find(".ui-slider-range").remove();
            
            var slider  = id.find(".bdaia_taqyeem_criteria_slider");
            var input   = id.find(".bdaia_taqyeem_criteria_score");
            var min     = 0;
            var max     = 100;
            var step    = 1;
            var value   = input.val();
