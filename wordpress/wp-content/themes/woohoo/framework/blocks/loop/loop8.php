		...
		<div class="block-article block-first-article">
			<article <?php woohoo_post_class(); ?>>
				...
				<div class="block-article-content-wrapper">
					...
					<?php if( ! $post_reviews ){ ?>
						<div style="display: none !important;" class="bd-more-btn"><a href="<?php the_permalink(); ?>"><?php woohoo_tr( 'Read More' ); ?><span class="bdaia-io <?php if( is_rtl() ) echo 'bdaia-io-chevron_left'; else echo 'bdaia-io-chevron_right'; ?>"></span></a></div>
					<?php } ?>
				</div>
			</article>
		</div>
